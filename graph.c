...
*
*/
void InitGraph(int argc,char *argv[], const char *WinName, const int w, const int h, void (*Draw)(void), void (*Key)(int), void (*Mouse)(int, int, int, int))
{
    glutInit(&argc,argv);
    Width=w;
    Height=h;
